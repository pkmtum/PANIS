...
randResBatchSize = 100 # number of randomly selected weight functions to approximate the ELBO
Navg = 100 # Number of samples used for statistics during validation
mean_px = 0 # Prior mean for px
sigma_px = 1 # Prior std for px
IterSvi = 7000 # Number of SVI iterations
...
# Path of the dataset
saveFolder = './Datasets/CMAME/darcy_'
