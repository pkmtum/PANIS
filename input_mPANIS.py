...
shapeFuncsDim = 63 # number of rbfs in each dimension for \w_j(s)
reducedDim = 9 # \sqrt{dimX}
...
yFMode=True # True for mPANIS and False for PANIS
Nx_samp = 10 # number of Monte Carlo Samples per iteration
randResBatchSize = 1500 # number of randomly selected weight functions to approximate the ELBO
Navg = 100 # Number of samples used for statistics during validation
mean_px = 0 # Prior mean for px
sigma_px = 1 # Prior std for px
IterSvi = 70000 # Number of SVI iterations
lr = 0.01 # Learning rate
sigma_rExponent = 2.2 # In paper it was 3.5 for PANIS and 2.2 for mPANIS
...
# Path of the dataset
saveFolder = './Datasets/CMAMEmPANIS/darcy_'
